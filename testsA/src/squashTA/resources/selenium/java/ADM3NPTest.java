...
public class ADM3NPTest {
  ...
  public void aDM3NP() {
    ...
    assertThat(driver.findElement(By.cssSelector(".navbar-text")).getText(), is("Basic user (Utilisateur)"));

    driver.findElement(By.linkText("Test Fonctionnel")).click();
    {
      List<WebElement> elements = driver.findElements(By.linkText("Utilisateurs inscrits"));
      assert(elements.size() == 0);
    }
    {
      List<WebElement> elements = driver.findElements(By.linkText("Annuler intervenant"));
      assert(elements.size() == 0);
    }
