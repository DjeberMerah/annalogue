...
public class INT5NPTest {
    ...
    public void tEST() {
        ...
        driver.manage().window().setSize(new Dimension(897, 835));
        ...
        driver.findElement(By.id("subject_name")).sendKeys("Pocket-Market");
        driver.findElement(By.id("subject_description")).click();
        driver.findElement(By.id("subject_description")).sendKeys("test");
