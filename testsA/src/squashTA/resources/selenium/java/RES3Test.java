...
public class RES3Test {
  ...
  public void rES3() {
    ...
    driver.findElement(By.xpath("/html/body/div[1]/table/tbody/tr[1]/td[5]/div[1]/button")).click();
    ...
    assertThat(driver.findElement(By.cssSelector(".alert")).getText(),is("Le module Test Fonctionnel a bien \u00e9t\u00e9 supprim\u00e9."));

    {
      List<WebElement> elements = driver.findElements(By.linkText("Test Fonctionnel"));
      assert(elements.size() == 0);
    }
