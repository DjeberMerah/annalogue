...
public class RES2Test {
  ...
  public void rES2() {
    ...
    driver.findElement(By.id("module_name")).clear();
    driver.findElement(By.id("module_name")).sendKeys("Tests");
    driver.findElement(By.id("module_submit")).click();

    assertThat(driver.findElement(By.xpath("//a[contains(text(),\'Tests\')]")).getText(), is("Tests"));

    assertThat(driver.findElement(By.cssSelector(".alert")).getText(), is("Le module Tests a bien \u00e9t\u00e9 modifi\u00e9."));
