...
public class RES5Test {
  ...
  public void rES5() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.xpath("//div[@id=\'subscribe_modal\']/div/form/div[2]/p"));
      assert(elements.size() > 0);
    }
    driver.findElement(By.name("user[]")).click();
    driver.findElement(By.cssSelector(".btn-primary")).click();
    {
      List<WebElement> elements = driver.findElements(By.xpath("//td[contains(.,\'resp@univ-fcomte.fr\')]"));
      assert(elements.size() > 0);
    }
