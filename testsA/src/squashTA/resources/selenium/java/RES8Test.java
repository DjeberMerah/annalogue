...
public class RES8Test {
  ...
  public void rES8() {
    ...
    driver.findElement(By.linkText("Annuler intervenant")).click();
    {
      List<WebElement> elements = driver.findElements(By.cssSelector(".alert"));
      assert(elements.size() > 0);
    }
    {
      List<WebElement> elements = driver.findElements(By.linkText("Rendre intervenant"));
      assert(elements.size() > 0);
    }
