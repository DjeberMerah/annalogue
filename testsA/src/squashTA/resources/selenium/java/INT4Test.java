...
public class INT4Test {
  ...
  public void t1() {
    ...
    driver.manage().window().setSize(new Dimension(897, 841));
    ...
    driver.findElement(By.cssSelector(".text-right > .btn-danger")).click();

    driver.findElement(By.linkText("Supprimer")).click();

    assertThat(driver.findElement(By.cssSelector(".alert-info")).getText(), Is.is("Ce module n'a pas encore de sujet."));
